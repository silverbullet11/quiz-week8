...
# 定义各目录
mkdir /data/silverbullet11/quiz-week8/output
output_dir=/data/silverbullet11/quiz-week8/output  # 训练目录
dataset_dir=/data/silverbullet11/quiz-week8 # 数据集目录，这里是写死的，记得修改
